# Ameizin AI News Intelligence Dashboard - Progress Tracking

## 1. Backend Infrastructure (ameizin-be)
- [x] Define News Schema (`src/db/models/news.ts`)
...
- [x] Setup API client for News
- [x] AI News Feed Page (`/news`)
- [x] Stock News Tab in Stock Detail (`/stock/[symbol]`)
- [x] AI Daily Brief Card (Homepage)
- [x] News Sentiment Dashboard (`/dashboard/news`)
- [x] Watchlist News Alerts
